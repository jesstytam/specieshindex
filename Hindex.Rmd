...
^kind of functional but needs more work
...
#how do i make it save all values instead of just the number of articles
```
...
Woylie <- Fetch(bettongia, penicillata) #fetch function not working yet

Pubxdf <- TotalPub(xdf) #929
Citexdf <- TotalCite(xdf) #16170
Journalxdf <- TotalJournals(xdf) #299
Ratioxdf <- Ratio(xdf) #890:39, 95.8019375672766:4.19806243272336; can't save all of the values tho
Hxdf <- Hindex(xdf) #53
