...
CountSpTAK("Bettongia", "penicillata", "442b9048417ef20cf680a0ae26ee4d86") #113
...
```{r, quokka}
#test done on 10 july
CountSpTAK("Setonix", "brachyurus", "442b9048417ef20cf680a0ae26ee4d86") #242
...
```{r, koala}
#test done on 10 july
CountSpTAK("Phascolarctos", "cinereus", "442b9048417ef20cf680a0ae26ee4d86") #777
...
CountSpTAK("Panthera", "tigris", "442b9048417ef20cf680a0ae26ee4d86")
...
fox <- FetchSpTAK("Vulpes", "vulpes", "442b9048417ef20cf680a0ae26ee4d86") #3324 results
...
cat <- CountSpT("felis", "catus", "442b9048417ef20cf680a0ae26ee4d86") #17622 results, error at 26%, current loop can only output 2000 records
gnr_resolve(names = c("felis", "catus"))

chimps <- FetchSpTAK("pan", "troglodytes", "442b9048417ef20cf680a0ae26ee4d86") #10018 results
chimps2 <- FetchTAK10k("pan", "troglodytes", "442b9048417ef20cf680a0ae26ee4d86")
...
possum <- FetchSpT("Burramys", "parvus", "442b9048417ef20cf680a0ae26ee4d86") #45
