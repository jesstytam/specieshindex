...
FetchSpT <- function(genus, species, additionalkeywords, APIkey) {
  ...
  if (count <= 5000) {
    ...
    for (i in 0:looprepeat) { 
      ...
      search <- scopus_search(query = create_query_string_T(genus, species, additionalkeywords),
      ...
      #search begins
      search1 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2018")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)
      search1df <- entries_to_citation_df(search1$entries)
      search2 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2018")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)
      search2df <- entries_to_citation_df(search2$entries)
      search3 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2017")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search3df <- entries_to_citation_df(search3$entries)
      search4 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2016")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search4df <- entries_to_citation_df(search4$entries)
      search5 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2015")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search5df <- entries_to_citation_df(search5$entries)
      search6 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2014")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search6df <- entries_to_citation_df(search6$entries)
      search7 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2013")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search7df <- entries_to_citation_df(search7$entries)
      search8 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2012")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search8df <- entries_to_citation_df(search8$entries)
      search9 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2011")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search9df <- entries_to_citation_df(search9$entries)
      search10 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2010")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search10df <- entries_to_citation_df(search10$entries)
      search11 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2009")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search11df <- entries_to_citation_df(search11$entries)
      search12 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2006 AND PUBYEAR < 2009")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search12df <- entries_to_citation_df(search12$entries)
      search13 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2004 AND PUBYEAR < 2007")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search13df <- entries_to_citation_df(search13$entries)
      search14 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2002 AND PUBYEAR < 2005")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search14df <- entries_to_citation_df(search14$entries)
      search15 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2000 AND PUBYEAR < 2003")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search15df <- entries_to_citation_df(search15$entries)
      search16 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1998 AND PUBYEAR < 2001")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search16df <- entries_to_citation_df(search16$entries)
      search17 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1996 AND PUBYEAR < 1999")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search17df <- entries_to_citation_df(search17$entries)
      search18 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1994 AND PUBYEAR < 1997")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search18df <- entries_to_citation_df(search18$entries)
      search19 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1992 AND PUBYEAR < 1995")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search19df <- entries_to_citation_df(search19$entries)
      search20 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1990 AND PUBYEAR < 1993")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search20df <- entries_to_citation_df(search20$entries)
      search21 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1985 AND PUBYEAR < 1991")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search21df <- entries_to_citation_df(search21$entries)
      search22 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1980 AND PUBYEAR < 1986")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search22df <- entries_to_citation_df(search22$entries)
      search23 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1975 AND PUBYEAR < 1981")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search23df <- entries_to_citation_df(search23$entries)
      search24 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1970 AND PUBYEAR < 1976")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search24df <- entries_to_citation_df(search24$entries)
      search25 <- scopus_search(query = paste0(create_query_string_T(genus, species, additionalkeywords), paste0(" AND PUBYEAR < 1971")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
...
FetchSpTAK <- function(genus, species, additionalkeywords, APIkey) {
  ...
  if (count <= 5000) {
    ...
    for (i in 0:looprepeat) { 
      print(paste("starting iteration: ", i, " Note: iteration size is ", step_size, " records, which runs of 200 records inside each iteration."))
      print(paste("Fetching records now."))
      search <- scopus_search(query = create_query_string_TAK(genus, species, additionalkeywords),
                              api_key = paste0(APIkey),
                              verbose = TRUE,
                              max_count = step_size,
                              start = step_size*i,
      ...
      #search begins
      search1 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2018")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)
      search1df <- entries_to_citation_df(search1$entries)
      search2 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2018")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)
      search2df <- entries_to_citation_df(search2$entries)
      search3 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2017")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search3df <- entries_to_citation_df(search3$entries)
      search4 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2016")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search4df <- entries_to_citation_df(search4$entries)
      search5 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2015")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search5df <- entries_to_citation_df(search5$entries)
      search6 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2014")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search6df <- entries_to_citation_df(search6$entries)
      search7 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2013")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search7df <- entries_to_citation_df(search7$entries)
      search8 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2012")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search8df <- entries_to_citation_df(search8$entries)
      search9 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2011")),
                               api_key = paste0(APIkey),
                               verbose = TRUE,
                               wait_time = 3)  
      search9df <- entries_to_citation_df(search9$entries)
      search10 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2010")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search10df <- entries_to_citation_df(search10$entries)
      search11 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR = 2009")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search11df <- entries_to_citation_df(search11$entries)
      search12 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2006 AND PUBYEAR < 2009")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search12df <- entries_to_citation_df(search12$entries)
      search13 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2004 AND PUBYEAR < 2007")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search13df <- entries_to_citation_df(search13$entries)
      search14 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2002 AND PUBYEAR < 2005")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search14df <- entries_to_citation_df(search14$entries)
      search15 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 2000 AND PUBYEAR < 2003")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search15df <- entries_to_citation_df(search15$entries)
      search16 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1998 AND PUBYEAR < 2001")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search16df <- entries_to_citation_df(search16$entries)
      search17 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1996 AND PUBYEAR < 1999")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search17df <- entries_to_citation_df(search17$entries)
      search18 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1994 AND PUBYEAR < 1997")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search18df <- entries_to_citation_df(search18$entries)
      search19 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1992 AND PUBYEAR < 1995")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search19df <- entries_to_citation_df(search19$entries)
      search20 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1990 AND PUBYEAR < 1993")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search20df <- entries_to_citation_df(search20$entries)
      search21 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1985 AND PUBYEAR < 1991")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search21df <- entries_to_citation_df(search21$entries)
      search22 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1980 AND PUBYEAR < 1986")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search22df <- entries_to_citation_df(search22$entries)
      search23 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1975 AND PUBYEAR < 1981")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search23df <- entries_to_citation_df(search23$entries)
      search24 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR > 1970 AND PUBYEAR < 1976")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search24df <- entries_to_citation_df(search24$entries)
      search25 <- scopus_search(query = paste0(create_query_string_TAK(genus, species, additionalkeywords), paste0(" AND PUBYEAR < 1971")),
                                api_key = paste0(APIkey),
                                verbose = TRUE,
                                wait_time = 3)  
      search25df <- entries_to_citation_df(search25$entries)
