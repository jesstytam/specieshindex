...
An individual token is required to extract data from Lens. You will not be able to use the Count and Fetch functions if your institution is not a subscriber of Lens. 
