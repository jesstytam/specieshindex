...
Multiple databases have been incorporated into `specieshindex`, namely Scopus, Web of Science, and BASE. To differentiate between them, set the `db` parameter to your desired database. If you are only interested in knowing how many publications there are, you can run the `Count()` functions.
