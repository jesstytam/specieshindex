...
```{r}
CountDomain <- function(genus, species, APIkey, keyword, datatype = "application/xml") {
  library(httr)
  library(XML)
  library(rlang)
  library(taxize)
...
CountDomain("Bettongia", "penicillata", myAPI, "conserv*") #36
...
CountDomain("Setonix", "brachyurus", myAPI, "conserv*") #26
...
CountDomain("Ornithorhynchus", "anatinus", myAPI, "conserv*") #63
...
CountDomain("Phascolarctos", "cinereus", myAPI, "conserv*") #166
