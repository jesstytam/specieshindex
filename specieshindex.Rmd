...
lens <- GET("https://api.lens.org/scholarly/search",
            query = list(Authorization = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb",
                         query = create_query_string_T_lens(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"')))
...
dat <- POST(url = "https://api.lens.org/scholarly/search",
     ...
     body = create_query_string_T_lens(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"')) #this works
rawToChar(dat$content) #this doesn't
