...
base <- httr::POST(url = "https://api.base-search.net/cgi-bin/BaseHttpSearchInterface.fcgi",
                      body = "dctitle:Macropus rufus") #format the URL to be sent to the API
http_status(base)
theData <- httr::content(base, as = "text", encoding = "application/xml")
