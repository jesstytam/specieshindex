...
test_TAK <- FetchSpTAK_wos(genus = "Bettongia", species = "penicillata")
...
results <- data.table::rbindlist(query, fill = TRUE) #does the same thing as the line above
...
results <- aggregate(results, by = results$ut, FUN = paste, collapse = ",")
...
for (i in 2:length(names(results))) {
  setDT(results)[, list(names(results)[i] = paste(names(results)[i], collapse = ",")), ut]
}



CountSpT_lens(genus = "Bettongia", species = "penicillata", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb", size = 1000)
woylie_lens_T_lens <- FetchSpT_lens(genus = "Bettongia", species = "penicillata", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb")
...
a <- Allindices(woylie_lens_T_scopus, genus = "Bettongia", species = "penicillata")
b <- Allindices(woylie_lens_T_lens, genus = "Bettongia", species = "penicillata")
bind_rows(a, b)
