...
0.3. create_query_string_T_wos (not working yet)
  + creates a query string to make functions with a query cleaner
  + title only
0.4. create_query_string_TAK_wos (not working yet)
  + creates a query string to make functions with a query cleaner
  + title + abstract + keywords
...
CountSpT_wos(genus = "Osphranter", species = "rufus")
CountSpT_wos(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"')
CountSpT_wos(genus = "Osphranter", species = "rufus", additionalkeywords = "conserv*")
CountSpT_wos(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"', additionalkeywords = "conserv*")

CountSpTAK_wos(genus = "Osphranter", species = "rufus")
CountSpTAK_wos(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"')
CountSpTAK_wos(genus = "Osphranter", species = "rufus", additionalkeywords = "conserv*")
CountSpTAK_wos(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"', additionalkeywords = "conserv*")

woylie_wos <- FetchSpT_wos(genus = "Bettongia", species = "penicillata")
CountSpTAK_wos(genus = "Bettongia", species = "penicillata", additionalkeywords = "conserv*")
woylie_wos_tak <- FetchSpTAK_wos(genus = "Bettongia", species = "penicillata", additionalkeywords = "conserv*") #not working with keyword
Allindices(woylie_wos_tak, genus = "Bettongia", species = "penicillata")
