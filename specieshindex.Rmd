...
```{r, function to get result count title only, message=FALSE, warning=FALSE}
...
```{r, function to get result count title+abs+key, message=FALSE, warning=FALSE}
#code from Fonti (modified)
...
FetchSpT("Phascolarctos", "cinereus", additionalkeywords = "(consrv* OR protect* OR reintrod* OR restor*)", "442b9048417ef20cf680a0ae26ee4d86")
FetchSpT("Phascolarctos", "cinereus", APIkey = "442b9048417ef20cf680a0ae26ee4d86") #4 duplicates
