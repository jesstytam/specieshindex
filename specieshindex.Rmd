...
```{r}
#genus check
genus_check_old <- function(genus) {
...
```{r, function to get result count from wos title only; genus}
...
```{r, function to get result count from wos title+abs+key; genus}
...
cat(create_query_string_TAK_scopus(genus = "Osphranter", species = "rufus"))
cat(create_query_string_TAK_scopus(genus = "Osphranter"))
