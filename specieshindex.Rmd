...
CountSpT_scopus_genus("drosophilla") #65802

genus <- "Macopus"
findname <- taxize::gnr_resolve(sci = paste(genus),
                                  data_source_ids = list("1", "3", "4", "12")) #check if the species exist
if (nrow(findname>0)) {
  findname <- findname[order(-findname$score),]
} else {
...
CountSpT_scopus("Macopus", "rufus")
CountSpT_scopus("Bettongia", "penicillata")
CountSpT_scopus("Betongia", "penicillata")
CountSpT_scopus("Bos", "taurus")
CountSpT_scopus("Bos", "tarus")
