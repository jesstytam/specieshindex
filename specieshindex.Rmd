...
```{r}
#species check
test_check <- function(genus, species = NULL) {
...
FetchSpT_scopus <- function(level = "t",
                            genus,
                            species,
                            synonyms,
                            additionalkeywords,
                            language = 0) {
  count <- Count_scopus(level,
                        genus,
                        species,
                        synonyms,
...
Count_test(level = "T", genus = "Osphranter", species = "rufus")

test <- Fetch(db = "scopus",
              search = "t",
              level = "species",
