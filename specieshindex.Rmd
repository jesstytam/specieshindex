...
#code from Fonti (modified)
CountSpTAK_scopus <- function(genus, species, synonyms, additionalkeywords, APIkey = APIkey, datatype = "application/xml") {
  if (missing(APIkey)) {
...
FetchSpT_scopus <- function(genus, species, synonyms, additionalkeywords, language = 0, APIkey = APIkey) {
...
#this function downloads citation data from scopus
FetchSpTAK_scopus <- function(genus, species, synonyms, additionalkeywords, language = 0, APIkey = APIkey) {
...
CountSpT_wrap <- function(db, genus, species, synonyms, additinoalkeywords, language, size) {
  if (db == "scopus") {
    countsp <- CountSpT_scopus(genus, species, synonyms, additionalkeywords, language)
  } else if (db == "wos") {
...
CountSpT_wrap("scopus", "Bettongia", "penicillata")
