...
FetchSpT_wos <- function(genus, species, synonyms, additionalkeywords) {
  query <- wosr::pull_wos(query = 'TS = "Bettongia penicillata"',
                          sid = sid) 
  results <- wosr::rbindlist(query, fill = TRUE)
...
test <- pull_wos(query = 'TS = "Bettongia penicillata"',
                 sid = sid)
query_wos(query = 'TS = "Bettongia penicillata"',
          sid = sid) #121 matching records
