...
base <- httr::GET("https://api.base-search.net/cgi-bin/BaseHttpSearchInterface.fcgi",
                      query = list(query = create_query_string_T_base(genus = "Osphranter", species = "rufus"))) #format the URL to be sent to the API
theData <- httr::content(base, as = "text", encoding = "UTF-8")
newData <- XML::xmlParse(base)
