...
0.4. create_query_string_TAK_wos
  + creates a query string to make functions with a query cleaner
  + title + abstract + keywords
0.5. create_query_string_T_lens
  + creates a query string to make functions with a query cleaner
  + title only
0.6. create_query_string_TAK_lens
  + creates a query string to make functions with a query cleaner
  + title + abstract + keywords
1. CountSpT
...
CountSpT_lens(genus = "Osphranter", species = "rufus", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #2750
CountSpT_lens(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"', token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #?
CountSpT_lens(genus = "Osphranter", species = "rufus", additionalkeywords = "conserv*", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #24
CountSpT_lens(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"', additionalkeywords = "conserv*", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #?

CountSpTAK_lens(genus = "Osphranter", species = "rufus", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #12
CountSpTAK_lens(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"', token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #?
CountSpTAK_lens(genus = "Osphranter", species = "rufus", additionalkeywords = "conserv*", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #3
CountSpTAK_lens(genus = "Osphranter", species = "rufus", synonyms = '"Macropus rufus"', additionalkeywords = "conserv*", token = "KeQCynn4V050fJZwOmaPIzUpAe7Fn5Y4rOkk79jb2IgUTSBwBBOb") #?
