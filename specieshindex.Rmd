...
unnest_query <- query %>% unnest_auto()
unnest_query <- query %>% unnest_wider(cols = list(publication, author, address, author_address, jsc, keyword, keywords_plus, grant, doc_type))
unnest_query <- query %>%
  bind_rows() %>%
  mutate_if(is.list, simplify_all) %>%
  unnest_wider(cols = c(publication, author, address, author_address, jsc, keyword, 
    keywords_plus, grant, doc_type))
