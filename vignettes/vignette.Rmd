...
```{r, eval=FALSE}
CountSpT("Bettongia", "penicillata", "API key")
```

```{r, eval=FALSE}
CountSpTAK("Bettongia", "penicillata", "API key")
```
...
```{r, eval=FALSE}
FetchSpT("Bettongia", "penicillata", "API key")
```

```{r, eval=FALSE}
FetchSpTAK("Bettongia", "penicillata", "API key")
```
